...
namespace rcsdk_test
{
   public struct RcTargetEntry
    ...
    public struct RcConversationEntry
    {
        public int typeId;
    };
    ...
    */
    public delegate void ConnectAckListenerEventHandler(string json_str);
    ...
    */
    public delegate void BizAckListenerEventHandler(string json_str);
    ...
    */
    public delegate void UserInfoListenerEventHandler(string json_str);
    ...
    */
    public delegate void EnvironmentChangeNotifyListenerEventHandler(string json_str);
   ...
   */
    ...
    unsafe class rcsdk
    {
        ...
        public static extern bool test_callback(RcTargetEntry[] userIds,int cnt,testCallbackEventHandler callback);

        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool test_function(testCallbackEventHandler callback);
        /**
        *  初始化全局实例
        *
        *  @param appid        应用id
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr InitClient(string appId, string appName, string deviceId, string localPath, string databasePath);
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Connect(string token, ConnectAckListenerEventHandler callback);
        /**
        *  断开服务器连接，不会删除全局实例
        *
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SaveMessage(string targetId, int categoryId, string clazzName, string senderId, [MarshalAs(UnmanagedType.LPWStr)] string message, string push, string appData);
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool GetConversationHistoryMessages(string targetId, int categoryId, int lastId, int count, MessageInfoEventHandler callback);

        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool SearchMessagesEx(string searchText, int lastId, int count, MessageInfoEventHandler callback);

        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool LoadHistoryMessage(string targetId, int categoryId, System.Int64 recordTime, int rowCount, MessageListenerEventHandler callback);
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool GetConversationList(RcConversationEntry[] conversationDict, int conversationCount, ConversationInfoEventHandler callback);
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool GetTopConversationList(RcConversationEntry conversationDict, int conversationCount, ConversationInfoEventHandler callback);
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int GetConversationUnreadCount(RcConversationEntry[] conversationDict, int conversationCount);
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool ClearConversations(RcConversationEntry[] conversationDict, int conversationCount);
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool DeleteMessage(RcConversationEntry[] messageId, int messageCount);
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void JoinChatRoom(string targetId, int conversationType, int messageCount, PublishAckListenerEventHandler callback);

        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void QuitChatRoom(string targetId, int conversationType, PublishAckListenerEventHandler callback);
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void EnvironmentChangeNotify(int nType, string pbData, int nDataSize, EnvironmentChangeNotifyListenerEventHandler callback);
        ...
        */
        ...
        [DllImport("rcsdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void TestJobjCall(JobjStrCallbackEventHandler callback);
